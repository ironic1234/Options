    ...
    for (double S = Sbottom; S <= Stop; S += Sincrement) {
        for (double V = Vbottom; V <= Vtop; V += Vincrement) {
            for (double x = 1; x<=T; x++) {
                double call = call_price(S, K, R/100, V/100, x/252);
                double calldelta = call_delta(S, K, R/100, V/100, x/252);
                double callgamma = call_gamma(S, K, R/100, V/100, x/252);
                double callvega = call_vega(S, K, R/100, V/100, x/252);
                double calltheta = call_theta(S, K, R/100, V/100, x/252);
                double callrho = call_rho(S, K, R/100, V/100, x/252);
...
int main(int argc, char **argv) {
    ...
    if (filey == "no" || filey == "n") {
        ...
        cout << "Days to expiry: ";
        cin >> T;
        cout << "Price: " << call_price(Sbottom, Kbottom, R/100, Vbottom/100, T/252) << "\n";
        cout << "Delta: " << call_delta(Sbottom, Kbottom, R/100, Vbottom/100, T/252) << "\n";
        cout << "Gamma: " << call_gamma(Sbottom, Kbottom, R/100, Vbottom/100, T/252) << "\n";
        cout << "Vega: " << call_vega(Sbottom, Kbottom, R/100, Vbottom/100, T/252) << "\n";
        cout << "Theta: " << call_theta(Sbottom, Kbottom, R/100, Vbottom/100, T/252) << "\n";
        cout << "Rho: " << call_rho(Sbottom, Kbottom, R/100, Vbottom/100, T/252) << "\n";
